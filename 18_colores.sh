...
## Los colores ANSI
# para darle color a los scripts debemos usar los còdigos ANSI
# junto "con echo -e". Para meter el caràcter especial escape
# usamos \033
...
# Esta es la muestra de colores, ejecùtalo para ver còmo queda
...
echo -e "\033[40m\033[33m Marròn	\033[0m"
